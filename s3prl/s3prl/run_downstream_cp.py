...
from s3prl.downstream.runner_cp import Runner
...
def get_downstream_args():
    ...
    parser.add_argument('--peft_layer_lst', default='all', type=str)
    ...
    parser.add_argument('--prompt_init', type=str2bool, default=False)
    parser.add_argument('--task', type=str, default="None", help="For prompt init (IC, ASR, PR, SF)")
